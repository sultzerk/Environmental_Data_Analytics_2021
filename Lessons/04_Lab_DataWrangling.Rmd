...
#matrix filtering 
sampl1 <- NTL.phys.data[NTL.phys.data$depth == 0, ] #leave blank after , b/c we want to grab all columns
...
NTL.phys.data.Tuesday90s <- filter(NTL.phys.data, lakename == "Tuesday Lake" & year4 %in% c(1990:1999))

```
Question: Why don't we filter using row numbers?

> Answer: not as reproducible in case your data was arranged differently than someone else's
