...
1. **YAML Header** surrounded by --- on top and bottom (kinda like metadata of document)
 ...
 * Languages other than R...(need to have Python installed to run it though)
 * Various outputs... (like presentations, Shiny, from 3rd party templates)
...
**Names of Datasets** | **Information about Datasets**
----------------- | --------------------------
ECOTOX neonicotinoid dataset | Neonicotinoids are a class of insecticides used widely in agriculture  
Niwot Ridge NEON dataset | contains information on litter and woody debris
EPA Air dataset | contains ozone and PM information
NTL-LTER raw dataset | contains information about lake chemistry and physics
...
#loading dataset and looking at display and setting date column
Lake_data <- read.csv("../Data/Raw/NTL-LTER_Lake_Nutrients_Raw.csv")
